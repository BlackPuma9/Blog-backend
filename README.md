...
Потрібно зробити табличку з категоріями (Categories). У кожного поста може бути тільки 1 категорія. А своєю чергою категорія може бути прив'язана до багатьох постів.
...
Вивести список постів одразу з категоріями.      `return this.postsRepository.find({ relations: ['category'] });`

# Filter
Додати можливість фільтрації списку постів по category_id
